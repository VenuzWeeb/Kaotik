...
public class FontRenderer {
    ...
    public int drawString(final String text, final float x, final float y, final int color, final boolean dropShadow) {
        ...
        if (dropShadow) {
            ...
            this.drawText(text, x + 1.0f, currY + 1.0f, -16777216, true);
        }
            ...
            for (int index = 0; index < parts.length; ++index) {
                ...
                if (!part.isEmpty()) {
                    if (index == 0) {
                        ...
                        if (strikeThrough) {
                            RenderUtils.drawLine(width / 2.0 + 1.0, currentFont.getHeight() / 3.0, (width + currentFont.getStringWidth(words)) / 2.0 + 1.0, currentFont.getHeight() / 3.0, this.getHeight() / 16.0f);
                        }
                        if (underline) {
                            RenderUtils.drawLine(width / 2.0 + 1.0, currentFont.getHeight() / 2.0, (width + currentFont.getStringWidth(words)) / 2.0 + 1.0, currentFont.getHeight() / 2.0, this.getHeight() / 16.0f);
                        }
