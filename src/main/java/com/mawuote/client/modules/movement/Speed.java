...
public class Speed extends Module {
    ...
    public static ValueBoolean strafeJump = new ValueBoolean( "Jump", Boolean.valueOf(false), "", "" == Mode.INSTANT));
    public static ValueBoolean noShake = this.register(new Setting<Object>("NoShake", Boolean.valueOf(true), v -> this.mode.getValue() != Mode.INSTANT));
    public static ValueBoolean useTimer = this.register(new Setting<Object>("UseTimer", Boolean.valueOf(false), v -> this.mode.getValue() != Mode.INSTANT));
